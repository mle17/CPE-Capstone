...
void main(void) {
    ...
    printf("Read in N\n");
    mp_int_read_string(&n, BASE, "99766c280d75d2e1dcb3f5cc878e61a858fa60c6c2de2befa63c202a8b0fcf83");
    printf("Read in d\n");
    mp_int_read_string(&d, BASE, "a36ffa1d012c0c56e2c1997458a3cc5f74532248cc36759d346ee18ef80179d");
