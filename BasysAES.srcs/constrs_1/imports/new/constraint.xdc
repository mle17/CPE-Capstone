...
set_property PACKAGE_PIN U16 [get_ports {correct_en}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {correct_en}]
set_property PACKAGE_PIN E19 [get_ports {correct_de}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {correct_de}]
#set_property PACKAGE_PIN U19 [get_ports {end_led}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {end_led}]
